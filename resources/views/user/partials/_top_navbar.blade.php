<div class="iq-top-navbar">
                ...
                <ul class="navbar-nav ml-auto navbar-list">
                    <li class="nav-item">
                        <a class="search-toggle iq-waves-effect language-title" href="#"><span
                                ...
                                class="img-fluid mr-1" style="height: 16px; width: 16px;"> EN </i></a>
            ...
            <ul class="navbar-list">
                <li class="line-height">
                    <a href="#" class="search-toggle iq-waves-effect d-flex align-items-center">
                        <img src="https://ui-avatars.com/api/?name={{ getFullName() }}" class="img-fluid rounded mr-3"
                            alt="user">
                        <div class="caption">
                               ...
                               <div class="media-body ml-3">
                                ...
                                <div class="d-inline-block w-100 text-center p-3">
                                    <a class="bg-primary iq-sign-btn" href="{{ route('logout') }}"
                                        onclick="event.preventDefault(); document.getElementById('logout-form').submit();"role="button">Sign
    ...
    @endif
    @include('user.partials._messagebox');
</div>
