                       ...
                       <div class="iq-card-body">
                          <div class="user-details-block">
                             <div class="user-profile text-center">
                                <img src="images/user/11.png" alt="profile-img" class="avatar-100 img-fluid rounded">
                             </div>
                 ...
                 <div class="col-md-6 col-lg-3">
                    <div class="iq-card iq-card-block iq-card-stretch iq-card-height" style="background: transparent; box-shadow: none;">
                       <div class="iq-card-body p-0">
                          <a href="#"><img src="images/booking/03.png" class="img-fluid w-100 rounded shadow" alt=""></a>
                       </div>
                    </div>
                 </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12 mb-3">
                                ...
                                <input type="text" required class="form-control required" id="first_name"
                                    name="first_name" placeholder="John" value="{{ auth()->user()->last_name }}">
                            </div>
