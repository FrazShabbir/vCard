...
@endif
    <section>
        <div class="container">
            ...
            <form class="vcard_wizard_form" role="form" action="{{ route('contact.store') }}" method="POST"
                                ...
                                <div class="col-lg-8 offset-lg-2">
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="email" class="form-control" name="email" id="email"
                                            placeholder="johndoe@gmail.com" value="{{old('email')}}" required="required">
                                    ...
                                    <div class="form-check mb-5">
                                        <input class="form-check-input " required name="terms" type="checkbox"
                                            value="1" id="term_check" checked>
                                        <label class="form-check-label" for="term_check">
                                            I agree with Terms & Conditions
                                        </label>
                                    </div>
                                    <div class="text-center">
                                        <button class="btn btn-primary px-5 rounded-pill nextBtn mb-5 pull-right first_step_btn"
                ...
                <div class="row setup-content" id="step-2">
                    <div class="col-xs-6 col-md-offset-3">
                        <div class="col-md-12">
                            <h3 class="mb-5 text-center">Upload Your Pictures</h3>
                            <div class="row">
                                <div class="col-12">
                                    <h5 class="mb-2 text-center">Profile Picture * <small>Max Size:2000KB</small></h5>
                            ...
                            <div class="text-center">
                                <button class="btn btn-warning rounded-pill px-5 mb-5 prevBtn btn-lg pull-left"
                ...
                <div class="row setup-content" id="step-3">
                    <div class="col-xs-6 col-md-offset-3">
                        <div class="col-md-12">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group mb-5">
                                        ...
                                        <input type="text" required class="form-control" name="last_name"
                                            id="last_name" placeholder="Doe" value="{{old('last_name')}}" >
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group mb-5">
                                        ...
                                        <input type="text" required class="form-control" name="phone"
                                            id="phone" placeholder="01234567" value="{{old('phone')}}" >
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group mb-5">
                                        ...
                                        <textarea type="text" required class="form-control" name="address" id="address"
                                            placeholder="Add your Address">{{old('address')}}</textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group mb-5">
                                        ...
                                        <input type="text" required class="form-control" name="bio"
                                            id="bio" placeholder="Add your bio" value="{{old('email')}}" >
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group mb-5">
                                        ...
                                        <input type="text" required class="form-control" name="organization"
                                            id="organization" placeholder="Add your organization" value="{{old('organization')}}" >
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group mb-5">
                                        ...
                                        <input type="text" required class="form-control" name="designation"
                                            id="Designation" placeholder="Add your Designation" value="{{old('designation')}}" >
                                    </div>
                                </div>
                            ...
                            <div class="text-center">
                                <button class="btn btn-warning rounded-pill px-5  prevBtn btn-lg pull-left"
                                    type="button">Previous</button>
