                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="username" name="username"
                                            placeholder="e.g. aliraza12" value="{{ old('username') }}">
                                    </div>
                                    <div class="col-md-6 col-sm-12 mb-3">
                                        <label for="email" class="required">Email address:</label>
                                        <input type="email" class="form-control" id="email" name="email"
                                            placeholder="e.g. abc@email.com" value="{{ old('email') }}">
                                    </div>
                                    <div class="col-md-6 col-sm-12 mb-3">
                                        <label for="phone" class="required">Phone:</label>
                                        <input type="text" class="form-control" required id="phone" name="phone"
                                            placeholder="e.g. 0000000" value="{{ old('phone') }}">
                                    </div>
                                    <div class="col-md-6 col-sm-12 mb-3">
                                        <label for="referral_code" class="">Referral Code:</label>
                                        <input type="text" class="form-control" id="referral_code" name="referral_code"
                                            placeholder="e.g. 0000000" value="{{ old('referral_code') }}">
                                    </div>
                                    <div class="col-md-6 col-sm-12 mb-3">
                                        <label for="referral_code" class="">Account Type:</label>
                                                    ...
                                                    <div class="col-md-3 col-sm-12">
                                                        <div class="custom-control custom-checkbox mb-3">
                                                            <input type="checkbox" name="roles[]"
                                                                class="custom-control-input" id="{{ $role->name }}"
                                                                value="{{ $role->name }}">
