<!-- meta tags -->
<meta charset="utf-8">
<meta name="keywords" content="{{ config('app.name') }} business website contact card nfc card" />
<meta name="description" content="Empowering Your Business Digitally" />
<meta name="author" content="www.vCards.pk" />
<meta name="viewport" content="width=device-width, initial-scale=1">

<!-- Title -->

<title>@yield('title', config('app.name') . ' - Empowering Your Business Digitally') | {{ fromSettings('site_title') }}</title>
